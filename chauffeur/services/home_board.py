...
BOARD_ICON_GROUPS = [
    ('Places', [
        ...
        # Heroicons v1 has no car or bus — the truck was standing in for
        # every vehicle a family actually drives. Hand-drawn in the same
        # optical language: 24 box, stroke paths, the truck's own wheels.
        ('car', [
            'M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z',
            'M5 17H4a1 1 0 01-1-1v-4a1 1 0 011-1h16a1 1 0 011 1v4a1 1 0 01-1 1h-1M9 17h6M4 11l2.3-4.6A2 2 0 018.1 5h7.8a2 2 0 011.8 1.1L20 11',
        ]),
        ('bus', [
            'M9 18a2 2 0 11-4 0 2 2 0 014 0zM19 18a2 2 0 11-4 0 2 2 0 014 0z',
            'M5 18H4a1 1 0 01-1-1V6a2 2 0 012-2h14a2 2 0 012 2v11a1 1 0 01-1 1h-1m-10 0h6M3 12h18M8 8h8',
        ]),
    ]),
    ('Time', [
    ...
    ('Food', [
        # A family hub's boards are named "Meals", "Groceries", "Snacks" —
        # and the set had almost nothing edible. Cart, bag and cake moved in
        # from Home (a group is presentation; stored keys never move); the
        # rest are hand-drawn in the set's own language.
        ...
        ('utensils', [
            'M4 3v6a2 2 0 002 2h2a2 2 0 002-2V3M7 3v18',
            'M20 12V3a4 4 0 00-4 4v3a2 2 0 002 2h2zm0 0v9',
        ]),
        ('mug', [
            'M5 4h11v9a4 4 0 01-4 4H9a4 4 0 01-4-4V4z',
            'M16 6h2a3 3 0 010 6h-2M6 21h9',
        ]),
        ('apple', [
            'M12 7c-1-2-3-3-5-2-3 1.5-3 6 0 10 1.5 2 3 4 5 4s3.5-2 5-4c3-4 3-8.5 0-10-2-1-4 0-5 2z',
            'M12 7c0-2 1-3.5 3-4',
        ]),
        ('icecream', ['M7 11a5 5 0 0110 0M7 11h10l-5 10-5-10z']),
        ('bowl', [
            'M4 13a8 8 0 0016 0H4z',
            'M9 9c0-1 .8-1.5.8-2.5S9 5 9 4m6 5c0-1 .8-1.5.8-2.5S15 5 15 4',
        ]),
    ]),
    ('Play', [
        ('ball', [
            'M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
            'M12 3v18M3 12h18M5.6 5.6c3.4 3.4 3.4 9.4 0 12.8M18.4 5.6c-3.4 3.4-3.4 9.4 0 12.8',
        ]),
        ('trophy', [
            'M8 21h8M12 17v4M6 4h12v6a6 6 0 01-12 0V4z',
            'M6 6H4a2 2 0 000 4h2M18 6h2a2 2 0 010 4h-2',
        ]),
        ('paw', [
            'M12 12.5c-2.8 0-5 2-5 4.4 0 1.5 1.1 2.6 2.5 2.6 1 0 1.6-.5 2.5-.5s1.5.5 2.5.5c1.4 0 2.5-1.1 2.5-2.6 0-2.4-2.2-4.4-5-4.4z',
            'M6.5 11a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM11 7a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM16 7a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM20.5 11a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z',
        ]),
        ('drop', ['M12 3s6 6.6 6 11a6 6 0 11-12 0c0-4.4 6-11 6-11z']),
        ('tree', ['M12 3l5 6h-3l4 5h-4l3 4H7l3-4H6l4-5H7l5-6z', 'M12 18v3']),
        ('tent', ['M2 20h20M4 20L12 5l8 15M12 11l-4.5 9M12 11l4.5 9']),
    ]),
    ('Home', [
        ...
        ('bed', ['M3 20v-8a2 2 0 012-2h14a2 2 0 012 2v8M3 17h18M7 10V8a2 2 0 012-2h6a2 2 0 012 2v2']),
        ('shirt', ['M9 4L4 7l2 3 2-1v11h8V9l2 1 2-3-5-3a3 3 0 01-6 0z']),
        ('medkit', [
            'M9 7V5a1 1 0 011-1h4a1 1 0 011 1v2M4 7h16a1 1 0 011 1v11a1 1 0 01-1 1H4a1 1 0 01-1-1V8a1 1 0 011-1z',
            'M12 11v6M9 14h6',
        ]),
