...
- **Errand Rules Engine**: Independent from global Routing Rules, the Errand Rules Engine matches created errands (via keywords or IDs) to automatically enforce constraints such as required drivers, passenger prohibitions, and specific time-of-day windows.
